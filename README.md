...
```zsh
source /path/to/pi-zsh/pi-zsh.plugin.zsh
```
...
```zsh
export PI_ZSH_BIN="/path/to/pi"
export PI_ZSH_MODEL="anthropic/claude-sonnet-4"
export PI_ZSH_SESSION_DIR="$HOME/.pi/agent/shell-sessions"
export PI_ZSH_HISTORY_MAX_COMMANDS=5
export PI_ZSH_HISTORY_ENABLED=true
```
